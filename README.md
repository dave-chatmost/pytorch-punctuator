...
### Train
```shell
$ CUDA_VISIBLE_DEVICES=0 python train_truncated_bptt.py --train_data exp-data/train-head10W --cv_data exp-data/valid --vocab exp-data/vocab --punc_vocab exp-data/punc_vocab --embedding_size 100 --hidden_size 100 --proj_size 100 --hidden_layers 1 --batch_size=256 --bptt_step=20 --half_lr --early_stop --epochs 7 --save_folder exp/lstm/h10w-test --checkpoint --verbose --print_freq 100 --lr 0.01> log/lstm-h10w-test &
